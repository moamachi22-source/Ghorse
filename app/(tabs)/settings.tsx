...
import { cancelAllNotifications, rescheduleAllNotifications } from '../../src/notifications/scheduler';
...
export default function SettingsScreen() {
  ...
  const loadSettings = async () => {
    try {
      ...
      setSettings({
        fontSize: (fontSize as FontSize) ? (fontSize as FontSize) : 'medium',
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.card}>
            <View style={styles.settingRow}>
              ...
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingSubtitle}>یادآوری زمان مصرف دارو</Text>
              </View>
            </View>
            ...
            <View style={styles.settingRow}>
              ...
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingSubtitle}>لرزش هنگام نوتیفیکیشن</Text>
              </View>
            </View>
            <View style={styles.divider} />
            <TouchableOpacity style={styles.settingRow} onPress={handleResetNotifications}>
              <Text style={styles.actionArrow}>←</Text>
              <View style={styles.settingInfo}>
                <Text style={styles.settingTitle}>بازنشانی آلارم‌ها</Text>
                <Text style={styles.settingSubtitle}>مثلاً بعد از ریستارت گوشی</Text>
              </View>
            </TouchableOpacity>
          </View>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(400)}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.settingSubtitle}>متن نمونه با اندازه انتخابی</Text>
            <Text style={[styles.fontPreview, { fontSize: getFontSizeValue(settings.fontSize) }]}>
            ...
            <View style={styles.fontSizeButtons}>
              {(['small', 'medium', 'large'] as FontSize[]).map((size) => (
                <TouchableOpacity
                  key={size}
                  style={[styles.fontSizeButton, settings.fontSize === size && styles.fontSizeButtonActive]}
                  onPress={() => handleFontSizeChange(size)}
                >
                  <Text style={[styles.fontSizeButtonText, settings.fontSize === size && styles.fontSizeButtonTextActive]}>
        ...
        <Animated.View entering={FadeInDown.delay(400).duration(400)}>
          ...
          <View style={[styles.card, styles.dangerCard]}>
            <TouchableOpacity style={styles.dangerButton} onPress={handleClearAllData}>
              <Text style={styles.dangerButtonText}>حذف همه داده‌ها</Text>
            </TouchableOpacity>
          </View>
        </Animated.View>

        <View style={styles.footer}>
          <Text style={styles.footerText}>ساخته شده با ❤️ برای سلامتی شما</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  dangerCard: { borderWidth: 1.5, borderColor: '#FF6B6B' },
  settingRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  settingInfo: { flex: 1, alignItems: 'flex-end', marginRight: 12 },
  settingTitle: { fontSize: 16, fontFamily: 'Vazirmatn_Bold', color: '#2D2D3A' },
  settingSubtitle: { fontSize: 13, fontFamily: 'Vazirmatn', color: '#9E9EA7', marginTop: 2 },
  actionArrow: { fontSize: 20, color: '#6C63FF' },
  divider: { height: 1, backgroundColor: '#F0EFFF', marginVertical: 4 },
  fontPreview: {
  ...
  fontSizeButtons: { flexDirection: 'row', gap: 8, marginTop: 4 },
  fontSizeButton: { flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: '#F0EFFF', alignItems: 'center' },
  fontSizeButtonActive: { backgroundColor: '#6C63FF' },
  fontSizeButtonText: { fontSize: 14, fontFamily: 'Vazirmatn_Bold', color: '#6C63FF' },
  fontSizeButtonTextActive: { color: '#FFFFFF' },
  aboutRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8 },
  aboutLabel: { fontSize: 15, fontFamily: 'Vazirmatn_Bold', color: '#2D2D3A' },
  aboutValue: { fontSize: 15, fontFamily: 'Vazirmatn', color: '#9E9EA7' },
  dangerButton: { paddingVertical: 12, alignItems: 'center' },
  dangerButtonText: { fontSize: 16, fontFamily: 'Vazirmatn_Bold', color: '#FF6B6B' },
  footer: { alignItems: 'center', paddingVertical: 24 },
  footerText: { fontSize: 13, fontFamily: 'Vazirmatn', color: '#9E9EA7' },
});
